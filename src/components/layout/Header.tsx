      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative" ref={menuRef}>
          ...
          >
            ...
            >
              {/* Sin logo del cliente todavía: iniciales. Cuando exista el logo,
                  poner /brand/ferretodo-logo.png en /public y usar next/image. */}
              <span className="text-xs font-bold tracking-tight text-[#3F8E91]">FT</span>
            </div>
